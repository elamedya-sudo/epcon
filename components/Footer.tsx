        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 md:gap-8 pb-12 border-b border-white/10">
          ...
          <div className="lg:col-span-4 flex flex-col space-y-5">
            ...
            <p className="text-sm text-white/60 leading-relaxed max-w-sm">
              TSE belgeli ve fümigasyon ruhsatlı uzman kadromuzla, İstanbul merkezli olarak Türkiye genelinde ev, villa ve kurumsal işletmeler için çevre dostu, kesin çözümlü hizmetler sunuyoruz.
            </p>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span className="text-white/60 leading-relaxed">
                  Armağanevler Mahallesi Güngör Sokak No:89/A Ümraniye/İstanbul
                </span>
              </li>
