...
export default function LeadHero({
  ...
  backgroundImage,
  reverseLayout = false // Varsayılan olarak form sağda (false) kalır
}: LeadHeroProps) {
  return (
    <section className="relative bg-navy-deeper overflow-hidden min-h-[86vh] px-6 py-16 md:px-10 md:py-20 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center font-barlow">
      ...
      {/* ── ARKA PLAN EFEKTLERİ VEYA GÖRSEL ── */}
      {backgroundImage ? (
      ...
      {/* ── METİNLER (reverseLayout true ise masaüstünde sağa geçer) ── */}
      ...
      {/* ── FORM (reverseLayout true ise masaüstünde sola geçer) ── */}
