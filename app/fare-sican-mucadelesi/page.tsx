      ...
      <section className="relative bg-navy py-24 px-6 md:px-10 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden md:block rounded-2xl overflow-hidden border-4 border-white/10 shadow-2xl relative min-h-[400px]">
             ...
             <img src="https://images.unsplash.com/photo-1599839619722-39751411ea63?q=80&w=1000&auto=format&fit=crop" alt="Fare ve Sıçan Mücadelesi" className="w-full h-full object-cover absolute inset-0" />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 md:px-10 bg-slate-50 border-t border-slate-200">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { title: "Fare Eve Nereden Girer?", href: "/blog/fare-eve-nereden-girer" },
              { title: "Fare ve Sıçan Arasındaki Farklar", href: "/blog/fare-ve-sican-arasindaki-farklar" },
              { title: "Kemirgen İstasyonları Nasıl Çalışır?", href: "/blog/kemirgen-istasyonlari-nasil-calisir" }
            ].map((blog, idx) => (
