      ...
      <section className="py-16 px-6 md:px-10 bg-slate-50 border-t border-slate-200">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { title: "Tahta Kurusu Nasıl Anlaşılır?", href: "/blog/tahta-kurusu-nasil-anlasilir" },
              { title: "Tahta Kurusu Uygulaması Öncesi Hazırlık", href: "/blog/tahta-kurusu-uygulamasi-oncesi-hazirlik" },
              { title: "Tahta Kurusu Eşyalardan Nasıl Taşınır?", href: "/blog/tahta-kurusu-esyalardan-nasil-tasinir" }
            ].map((blog, idx) => (
