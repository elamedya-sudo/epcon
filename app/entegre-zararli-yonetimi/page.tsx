...
export default function IpmPage() {
  return (
    <main className="flex flex-col min-h-screen bg-white font-barlow">
      ...
      {/* 1. HERO ALANI (Metin Solda, Piramit Sağda Olacak Şekilde 2 Sütunlu Tasarım) */}
      <section className="relative bg-navy py-20 lg:py-24 px-6 md:px-10 overflow-hidden flex items-center">
        ...
        <div className="max-w-7xl mx-auto relative z-10 w-full grid lg:grid-cols-12 gap-12 items-center">
          ...
          {/* Sol Kısım: Metinler ve Butonlar */}
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            <span className="inline-block bg-pest-green/20 text-pest-green font-bold px-4 py-1.5 rounded-full text-[11px] md:text-sm uppercase tracking-wider border border-pest-green/30 mb-6">
              RİSK ANALİZİ • SÜREKLİ İZLEME • DİJİTAL RAPORLAMA
            </span>
            
            <h1 className="font-barlowCondensed text-4xl md:text-5xl lg:text-6xl font-extrabold uppercase text-white leading-[1.05] mb-6">
              Zararlı Risklerini <span className="text-pest-green">Entegre Bir Yönetim Sistemiyle</span> Kontrol Altına Alın
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              ...
              <a href="https://wa.me/905316901071" target="_blank" rel="noreferrer" className="w-full sm:w-auto bg-white/5 text-white font-bold px-8 py-4 rounded-lg hover:bg-white/10 transition-colors border border-white/20 flex justify-center items-center gap-2 text-sm tracking-wide">
                WhatsApp'tan Uzmana Sor
              </a>
            </div>
          </div>

          {/* Sağ Kısım: Piramit Görseli */}
          <div className="lg:col-span-5 flex justify-center lg:justify-end items-center relative">
            {/* Görselin arkasına hafif bir parlama efekti (Glow) eklendi */}
            <div className="absolute inset-0 bg-pest-green opacity-20 blur-[80px] rounded-full z-0"></div>
            
            <img 
              src="/images/piramit.png" 
              alt="Entegre Zararlı Yönetimi (IPM) Piramidi" 
              className="w-full max-w-[400px] lg:max-w-full h-auto object-contain drop-shadow-2xl relative z-10" 
            />
          </div>
      ...
      {/* 3. IPM NEDİR VE NEDEN GEREKLİDİR? */}
      ...
      {/* 4. 7 ADIMDA EPCON IPM UYGULAMA MODELİ */}
      ...
      {/* 6. TEKNİK SİSTEMLER VE TREND ANALİZİ */}
      ...
      {/* 7. ALT CTA (Dokümandaki Özel Teklif Çağrısı) */}
