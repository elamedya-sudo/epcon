        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {sektorler.map((sektor, idx) => (
              <div key={idx} className={`bg-white/5 border border-white/10 rounded-xl p-6 text-center hover:bg-white/10 transition-colors ${idx === 8 ? "lg:col-start-3" : ""}`}>
                <div className="text-pest-green flex justify-center mb-4">
                  {sektor.icon}
                </div>
