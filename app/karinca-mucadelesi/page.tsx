      ...
      <section className="relative bg-navy py-24 px-6 md:px-10 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden md:block rounded-2xl overflow-hidden border-4 border-white/10 shadow-2xl relative min-h-[400px]">
             ...
             <img src="https://images.pexels.com/photos/35702439/pexels-photo-35702439.jpeg?q=80&w=1000&auto=format&fit=crop" alt="Profesyonel Karınca Kontrolü" className="w-full h-full object-cover absolute inset-0" />
          </div>
        </div>
      </section>
      <ReferenceLogos />
